					...
					<form action="{{url('register')}}" id="register-form" method="POST">
						<table>
							<tr>
								...
								<td> <input type="text" id="username" name="username" placeholder="tentaikhoan" value="{{old('username')}}" required /></td>
							</tr>
							...
							<tr>
								...
								<td><input type= "text" id="HoVaTen" name="HoVaTen" placeholder="Nguyễn Văn A" value="{{old('HoVaTen')}}" required /></td>
							</tr>
							...
							<tr>
								...
								<td><input type= "date" id="NgaySinh" name="NgaySinh" value="{{old('NgaySinh')}}" required /></td>
							</tr>
							...
							<tr>
								...
								<td><select  id="GioiTinh" name="GioiTinh" value="{{old('GioiTinh')}}" required>
							...
							<tr>
								...
								<td><input type= "email" id="email" name="email" placeholder="mail@mail.com" value="{{old('email')}}" required /></br></td>
							</tr>
							...
							<tr>
								...
								<td><input type= "text" id="DiaChi" name="DiaChi" placeholder="123/đường 1" value="{{old('DiaChi')}}" required /></br></td>
							</tr>
							...
							<tr>
								...
								<td><select id="ThanhPho" name="ThanhPho" value="{{old('ThanhPho')}}" required />
							...
							<tr>
								...
								<td><select id="Quan" name="Quan" value="{{old('Quan')}}" required />
